...
//=============================================
    std::cout << " ===================================================================="<< std::endl;
    std::cout << std::endl;
    //std::flush flushes output buffer to its final destination.
    std::cout << "this is a nice message..." << std::endl << std::flush;
    //after this std::flush were sure this at this line the message has ben sent to the stram this may be important in some applications
    // is sent directly to terminal
...
//===========================
    ...
    //can also set a variable and then manipulate the width that way
    int col_width{14};
    ...
    //different number systems : std::dec, std::hex, std::oct key forces the out puts to be in these dose not work on floating point numbers
    ...
    std::cout.unsetf(std::ios::scientific | std::ios::fixed); // Hack to reset floting point output
    std::cout << "a : " << a << std::endl;
    std::cout << "b : " << b << std::endl;
    std::cout << "c : " << c << std::endl;
